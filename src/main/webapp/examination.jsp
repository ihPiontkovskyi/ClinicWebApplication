        ...
        <tr class="row">
            ...
            <td>
                ...
                <select class="selectPatient" disabled="disabled">
                    ...
                    <option selected="selected" value="<%=p.getPatientId()%>"><%=p.toString()%>
                    </option>
                    <%} else {%>
                    <option value="<%=p.getPatientId()%>"><%=p.toString()%>
                    </option>
                    <%}%>
                    <%}%>
                </select>
            ...
            <td>
                ...
                <select class="selectDiagnosis" disabled="disabled">
                    ...
                    <option selected="selected" value="<%=p.getDiagnosisId()%>"><%=p.toString()%>
                    </option>
                    <%} else {%>
                    <option value="<%=p.getDiagnosisId()%>"><%=p.toString()%>
                    </option>
                    <%}%>
                    <%}%>
                </select>
            ...
            <td>
                ...
                <select class="selectStaff" disabled="disabled">
                    ...
                    <option selected="selected" value="<%=p.getStaffId()%>"><%=p.toString()%>
                    </option>
                    <%} else {%>
                    <option value="<%=p.getStaffId()%>"><%=p.toString()%>
                    </option>
                    <%}%>
                    <%}%>
                </select>
